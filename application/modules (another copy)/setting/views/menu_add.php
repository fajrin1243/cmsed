								...
								<div class="tab-pane active" id="general"> 
									<form class="form-horizontal" role="form" method="post" action="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/save">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<select class='form-control search-select' required name="kodeInduk" id="kodeInduk">
													<option></option>
													<?php
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" required name="namaMenu" class="form-control" placeholder="Nama Menu" value="<?php echo ($getMenu) ? $getMenu[0]['namaMenu'] : "" ?>">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 col-sm-2 control-label">Icon</label>
											<div class="col-sm-6">
												<input type="text" required class="form-control icp icp-auto" id="iconModule" name="iconMenu" placeholder="Klik disini..." value="<?php echo ($getMenu) ? $getMenu[0]['iconMenu'] : "" ?>">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 col-sm-2 control-label">Order</label>
											<div class="col-sm-6">
												<input type="text" required class="form-control" id="orderMenu" name="orderMenu" placeholder="Urutan Menu" value="<?php echo ($getMenu) ? $getMenu[0]['orderMenu'] : "" ?>">
											</div>
										</div>
										<div class="form-group">
