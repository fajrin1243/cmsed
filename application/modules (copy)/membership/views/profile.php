...
if($save_info || $this->session->userdata('actSetting')){
        $actSetting = "active";
}else{
        $actSetting = "";
}
...
<div class="wraper container-fluid">
                ...
                <div class="col-sm-12">
                        <div class="bg-picture text-center" style="background-image:url('<?= base_url('assets/images/big/bg.jpg') ?>')">
                                ...
                                <div class="profile-info-name">
                                        ...
                                        <h3 class="text-white"><?= getMember('nameUser') ?></h3>
                                </div>
                        </div>
                </div>
        </div>
        <div class="row user-tabs">
                <div class="col-lg-6 col-md-9 col-sm-9">
                        <ul class="nav nav-tabs tabs">
                                ...
                                <li class="<?= $actSetting ?> tab">
                                        <a href="#settings-2" data-toggle="tab" aria-expanded="false" class="<?= $actSetting ?>">
        ...
        <div class="row">
                <div class="col-lg-12">
                                                        ...
                                                        <div class="panel panel-default panel-fill">
                                                                ...
                                                                <div class="panel-body">
                                                                        <div class="about-info-p">
                                                                                ...
                                                                                <br>
                                                                                <p class="text-muted"><?= getMember('nameUser') ?></p>
                                                                        </div>
                                                                        <div class="about-info-p">
                                                                                <strong>Email</strong>
                                                                                <br>
                                                                                <p class="text-muted"><?= getMember('emailUser') ?></p>
                                                                        </div>
                                                                        <div class="about-info-p m-b-0">
                                                                                <strong>Location</strong>
                                                                                <br>
                                                                                <p class="text-muted">
                                                                                        <?= getMember('nama_kota').", ".getMember('nama_provinsi') ?>
                                                                                </p>
                                                                        </div>
                                                                </div>
                                                        </div>
                        ...
                        <div class="tab-pane <?= $actSetting ?>" id="settings-2">
                                ...
                                <div class="panel panel-default panel-fill">
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <form action="<?= base_url(getModule().'/'.getController().'/save/info') ?>" method="POST" role="form">
                                                        <div class="form-group">
                                                                <label>Username</label> <small class="text-danger">* Usernames cannot be changed.</small>
                                                                <input type="text" value="<?= getMember('usernameUser') ?>" class="form-control" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                                <label>Full Name</label>
                                                                <input type="text" name="nameUser" value="<?= getMember('nameUser') ?>" class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                                <label>Email</label>
                                                                <input type="email" name="emailUser" value="<?= getMember('emailUser') ?>" class="form-control" required>
                                                                <?php echo form_error('emailUser'); ?>
                                                        </div>
                                                        <div class="form-group">
                                                                <label>Handphone</label>
                                                                <input type="text" name="phone" value="<?= getMember('phone') ?>" class="form-control" onkeyup="number(this);" required>
                                                                <?php echo form_error('phone'); ?>
                                                        </div>
                                                        <div class="form-group">
                                                                <label>Pekerjaan</label>
                                                                <input type="text" name="pekerjaan" value="<?= getMember('pekerjaan') ?>" class="form-control">
                                                        </div>
<!--                                                         <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <textarea style="height: 125px" name="aboutMe" class="form-control"><?= getMember('aboutMe') ?></textarea>
                                                        </div>
