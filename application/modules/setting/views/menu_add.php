					...
					<div class="row"> 
						<div class="col-lg-12"> 
							<ul class="nav nav-tabs navtab-bg"> 
								...
								<li class=""> 
									<a href="<?php echo ($getMenu) ? '#detail' : "javascript:void(0)" ?>" data-toggle="<?php echo ($getMenu) ? 'tab' : "" ?>" aria-expanded="false" id="tab-detail"> 
										<span class="visible-xs"><i class="fa fa-user"></i></span> 
										<span class="hidden-xs">Detail</span> 
									</a> 
								</li> 
								<li class=""> 
									<a href="<?php echo ($getMenu) ? '#attribute' : "javascript:void(0)" ?>" data-toggle="<?php echo ($getMenu) ? 'tab' : "" ?>" aria-expanded="false" id="tab-attribute"> 
							...
							<div class="tab-content"> 
								<div class="tab-pane active" id="general"> 
									<form class="form-horizontal" role="form" method="post" action="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/save">
										<input type="hidden" name="idMenu" id="idMenu" class="form-control" value="<?php echo ($getMenu) ? $getMenu[0]['idMenu'] : "" ?>">
										...
										<?php echo input_text_group('orderMenu','Order',(@$getMenu[0]['orderMenu']) ? @$getMenu[0]['orderMenu'] : "",'Order Menu','required') ?>
