		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Master Menu</h3>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-6 text-right">
							<div class="btn-group dropdown">
								<button type="button" class="btn btn-success waves-effect waves-light">Pilih module</button>
									...
									foreach ($data as $row => $value) {
										...
										<tr>
											...
											<td style="vertical-align:middle;" class="text-center">
												<a href="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/add/<?php echo $value['idMenu'] ?>">
													<button class="btn btn-icon waves-effect waves-light btn-primary btn-xs m-b-5"><i class="fa fa-pencil"></i></button>
												</a>
													<a href="<?php echo base_url(getModule().'/'.getController().'/delete/'.$value['idMenu']) ?>">
													<button class="btn btn-icon waves-effect waves-light btn-danger btn-xs m-b-5"><i class="fa fa-trash"></i></button>
												</a>
											</td>
										</tr>
										<?php 
										...
										foreach ($subMenu as $subkey => $subvalue) {
											...
											<tr>
												...
												<td style="vertical-align:middle;" class="text-center"><?= $status ?></td>
												<td style="vertical-align:middle;" class="text-center">
													<a href="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/add/<?php echo $subvalue['idMenu'] ?>">
														<button class="btn btn-icon waves-effect waves-light btn-primary btn-xs m-b-5"><i class="fa fa-pencil"></i></button>
													</a>
													<a href="<?php echo base_url(getModule().'/'.getController().'/delete/'.$subvalue['idMenu']) ?>">
														<button class="btn btn-icon waves-effect waves-light btn-danger btn-xs m-b-5"><i class="fa fa-trash"></i></button>
													</a>
												</td>
											</tr>
