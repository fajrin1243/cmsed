					...
					<div class="row"> 
						<div class="col-lg-12"> 
							<form class="form-horizontal" role="form" method="post" action="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/save">
								...
								<?php echo input_textarea_group('descModule','Keterangan',(@$getModule[0]['descModule']) ? @$getModule[0]['descModule'] : set_value('descModule'),'Keterangan Modul','required') ?>
								<?php echo input_icon_group('iconModule','Icon',(@$getModule[0]['iconModule']) ? @$getModule[0]['iconModule'] : set_value('iconModule'),'Klik disini...','required') ?>
								<?php echo input_text_group('orderModule','Order',(@$getModule[0]['orderModule']) ? @$getModule[0]['orderModule'] : set_value('orderModule'),'Order Modul','required') ?>
