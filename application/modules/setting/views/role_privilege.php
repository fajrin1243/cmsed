							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									foreach ($getMenuPrivilege as $subkey => $subvalue) {
										$getPrivilegeUser = $this->model->get_where('privilege_user',array('menuPrivilege'=>$subvalue['idMenu'],'actionPrivilege'=>$subvalue['actionMenuPrivilege']));
										print_r($getPrivilegeUser);
										?>
