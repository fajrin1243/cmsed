	...
	<div class="topbar-left">
		<div class="text-center">
			<a href="<?= base_url() ?>" class="logo">
				<i class="md md-terrain"></i> <span>IKASA72</span>
			</a>
		</div>
	</div>
...
<!--  				<form class="navbar-form pull-left" role="search">
			...
			<ul class="nav navbar-nav navbar-right pull-right">
				<li class="dropdown hidden-xs">
					<a href="#" data-target="#" class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><i class="md md-notifications"></i> <span class="badge badge-xs badge-danger">3</span>
					</a>
						...
						<li class="list-group"><!-- list item-->
							...
							<a href="javascript:void(0);" class="list-group-item">
								<div class="media">
									...
									<div class="media-body clearfix">
										<div class="media-heading">New settings
										</div>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="<?= base_url('membership/profile') ?>"><i class="md md-face-unlock"></i> Profile</a>
						</li>
						<li>
							<a href="javascript:void(0)"><i class="md md-settings"></i> Settings</a>
						</li>
						<li>
							<a href="<?= base_url('membership/logout') ?>"><i class="md md-settings-power"></i> Logout</a>
						</li>
					</ul>
				</li>
			</ul>
